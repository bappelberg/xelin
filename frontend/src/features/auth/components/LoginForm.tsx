    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#1e3d8c] flex-col items-center justify-center gap-8 p-12">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-semibold text-white tracking-wide">Xelin</h1>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="flex flex-col items-center mb-8 lg:hidden">
            <Image
              ...
              priority
            />
            <h1 className="mt-4 text-xl font-semibold text-[#1e3d8c]">Xelin</h1>
          </div>

          <h2 className="text-2xl font-semibold text-zinc-900 mb-1">Logga in</h2>
          <p className="text-sm text-zinc-500 mb-8">Ange dina LDAP-uppgifter</p>
